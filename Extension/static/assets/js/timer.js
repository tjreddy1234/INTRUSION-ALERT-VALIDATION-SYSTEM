...
timer.getReferences = function() {
  ...
  timer.days = timer.timer.querySelectorAll(".days .timer-number")[0];
  timer.hours = timer.timer.querySelectorAll(".hours .timer-number")[0];
  timer.minutes = timer.timer.querySelectorAll(".minutes .timer-number")[0];
  timer.seconds = timer.timer.querySelectorAll(".seconds .timer-number")[0];
}
